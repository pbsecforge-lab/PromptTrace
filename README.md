...
**PromptTrace** is a forensic extraction tool designed to identify, extract, and analyze artifacts generated by AI coding assistants (GitHub Copilot, Claude, etc.) stored in Visual Studio Code's local databases.
